        ...
        <div className="bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10 rounded-lg">
          <div className="sm:flex items-center justify-between">
            <div className="flex items-center gap-4 sm:gap-8 text-sm">
              <a href="#">
                <div className="py-1 px-6 bg-indigo-100 text-indigo-700 rounded-lg">
                  <p>All</p>
                </div>
              </a>
              <a href="#">
                <div className="py-1 px-6 text-gray-600 hover:text-indigo-700 hover:bg-indigo-100 rounded-lg">
                  <p>Done</p>
                </div>
              </a>
              <a href="#">
